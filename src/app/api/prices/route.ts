...
const PRODUCTS = {
  viandes: {
    'boeuf hache maigre': makePrices(12.99, 'kg'),
    'boeuf hache mi-maigre': makePrices(10.99, 'kg'),
    'boeuf hache regulier': makePrices(8.99, 'kg'),
    'steak hache': makePrices(11.99, 'kg'),
    'boulettes de boeuf': makePrices(9.99, 'kg'),
    'haut de surlonge': makePrices(17.99, 'kg'),
    'bifteck surlonge': makePrices(22.99, 'kg'),
    'roti de boeuf': makePrices(15.99, 'kg'),
    'ribs de boeuf': makePrices(18.99, 'kg'),
    'filet de porc': makePrices(10.99, 'kg'),
    'cotelettes de porc': makePrices(7.99, 'kg'),
    'epaule de porc': makePrices(5.99, 'kg'),
    ...
    'dinde entiere': makePrices(2.49, 'lb'),
  ...
  fruits: {
    ...
    'citrons': makePrices(0.99, 'unite'),
    'limes': makePrices(0.79, 'unite'),
    'fraises': makePrices(4.99, '454g'),
    'bleuets': makePrices(5.99, '340g'),
    'framboises': makePrices(5.99, '340g'),
    'mangues': makePrices(1.49, 'unite'),
    'avocats': makePrices(1.29, 'unite'),
    'ananas': makePrices(3.99, 'unite'),
    'raisins': makePrices(3.49, 'lb'),
    'poires': makePrices(2.29, 'lb'),
    'peches': makePrices(2.99, 'lb'),
    'kiwis': makePrices(0.69, 'unite'),
  },
  legumes: {
    'carottes': makePrices(1.99, '2lb'),
    'brocoli': makePrices(2.49, 'unite'),
    'chou-fleur': makePrices(3.99, 'unite'),
    'epinards': makePrices(3.49, '225g'),
    'laitue romaine': makePrices(2.49, 'unite'),
    'tomates': makePrices(2.49, 'lb'),
    'tomates cerises': makePrices(3.99, '227g'),
    'concombres': makePrices(1.29, 'unite'),
    'poivrons verts': makePrices(1.49, 'unite'),
    'oignons jaunes': makePrices(1.49, '3lb'),
    'ail': makePrices(0.99, 'tete'),
    'celeri': makePrices(2.99, 'unite'),
    'champignons': makePrices(2.99, '227g'),
    'courgettes': makePrices(2.49, 'lb'),
    'pommes de terre': makePrices(4.99, '10lb'),
    'mais en epi': makePrices(0.99, 'unite'),
  ...
  laitiers: {
    ...
    'beurre sale': makePrices(6.99, '454g'),
    'fromage cheddar': makePrices(8.99, '400g'),
    'fromage mozzarella': makePrices(7.99, '400g'),
    'fromage rape': makePrices(6.99, '320g'),
    'creme sure': makePrices(3.49, '500ml'),
  ...
  epicerie: {
    ...
    'pates spaghetti': makePrices(2.49, '900g'),
    'pates penne': makePrices(2.79, '900g'),
    'farine': makePrices(5.99, '2.5kg'),
    'sucre': makePrices(3.99, '2kg'),
    'miel': makePrices(8.99, '500g'),
    'sirop erable': makePrices(12.99, '540ml'),
    ...
    'mais conserve': makePrices(1.29, '341ml'),
    'thon conserve': makePrices(3.49, '170g'),
    'pain tranche': makePrices(3.49, '675g'),
    'bagels': makePrices(3.99, '6 unites'),
    'tortillas': makePrices(3.99, '10 unites'),
    'avoine': makePrices(5.99, '1kg'),
    'cereales': makePrices(5.99, '525g'),
    'cafe': makePrices(11.99, '907g'),
    'the': makePrices(4.99, '72 sachets'),
    'croustilles': makePrices(4.99, '255g'),
    'biscuits': makePrices(4.99, '400g'),
    'noix': makePrices(9.99, '400g'),
  },
  surgeles: {
    'pizza pepperoni': makePrices(6.99, 'unite'),
    'pizza fromage': makePrices(6.49, 'unite'),
    'legumes surgeles': makePrices(3.99, '1kg'),
    'frites': makePrices(4.99, '1kg'),
    'nuggets poulet': makePrices(8.99, '800g'),
    'poisson pane': makePrices(9.99, '500g'),
    'creme glacee vanille': makePrices(6.99, '2L'),
  },
  boissons: {
    'eau embouteillee': makePrices(3.99, '24x500ml'),
    'jus orange': makePrices(5.99, '1.89L'),
    'jus pomme': makePrices(4.99, '1.89L'),
    'cola': makePrices(3.99, '2L'),
    'the glace': makePrices(2.99, '1.89L'),
  },
  hygiene: {
    'savon vaisselle': makePrices(3.49, '739ml'),
    'detergent lessive': makePrices(12.99, '4.43L'),
...
export async function GET(request: NextRequest) {
  ...
  if (list === 'categories') {
    return NextResponse.json({ 
      ...
      totalProducts: Object.values(PRODUCTS).reduce((s, c) => s + Object.keys(c).length, 0) 
    });
  }
  ...
  if (q) {
    ...
    if (results.length === 0) {
      return NextResponse.json({ 
        success: false, 
        error: 'Non trouve', 
        suggestion: 'viandes, fruits, legumes, laitiers, epicerie, surgeles, boissons, hygiene' 
      });
    }
